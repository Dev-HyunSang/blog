      ...
      <div className="whitespace-pre-wrap">
        ...
        <div className="my-8">
          <div className="mb-9 mt-5">
            <p>소프트웨어 엔지니어링 분야 중 백엔드 개발에 관심이 많고 다양한 경험을 통해서 성장한 내용들을 글로서 기록에 남깁니다.
              학부에선 정보보호를 전공하고 있습니다. 소프트웨어의 보안적 안전성에 대해서 생각을 하며, 어떻게 하면 사용자 관점에서 안전한 서비스 환경을 만들어 나갈 수 있을지에 대해 항상 공부하며 경험하고 있습니다.
